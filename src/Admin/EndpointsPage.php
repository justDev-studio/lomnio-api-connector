...
final class EndpointsPage {
	...
	public function render(): void {
		...
		<div class="wrap">
			...
			<p><?php echo esc_html__( 'Webhook requests require a valid X-Lomnio-Signature generated with the project signing secret. Configure the secret on the API token settings page.', 'lomnio-api-connector' ); ?></p>
